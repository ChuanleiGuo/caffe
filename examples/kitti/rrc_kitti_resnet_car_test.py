...
caffe.set_mode_gpu()
num_img =7518
model_def = 'models/ResNet/KITTI/RRC_2560x768_kitti_car/deploy.prototxt'
model_weights = 'models/ResNet/KITTI/RRC_2560x768_kitti_car/ResNet_KITTI_RRC_2560x768_kitti_car_iter_60000.caffemodel'
voc_labelmap_file = caffe_root+'data/KITTI-car/labelmap_voc.prototxt'
save_dir = 'models/ResNet/KITTI/RRC_2560x768_kitti_car/result-test/'
txt_dir = 'models/ResNet/KITTI/RRC_2560x768_kitti_car/result-test/'
